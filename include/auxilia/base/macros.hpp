#pragma once
#include "internal/variadic-inl.h"
...
EXPORT_AUXILIA
template <class Fun_>
AC_FLATTEN AC_FORCEINLINE static inline constexpr auto
...
#  define AC_DEBUG_BLOCK                                                       \
    ::auxilia::details::_dbg_block_helper_struct_{} *[&]()                     \
...
#define AC_DEBUG_BREAK                                                         \
  do {                                                                         \
    if (::auxilia::details::_is_debugger_present()) {                          \
...
#  define AC_PRINT_ERROR_MSG_IMPL_WITH_MSG(x, _msg_)                           \
    spdlog::critical(::auxilia::details::_fancy_error_message_,                \
                     AC_FILENAME,                                              \
                     AC_FUNCTION_NAME,                                         \
                     AC_LINE,                                                  \
                     AC_COLUMN,                                                \
                     #x,                                                       \
                     (_msg_),                                                  \
                     ::auxilia::details::_is_debugger_present()                \
...
#define AC_DEFER                                                               \
  [[maybe_unused]] const auto AC_EXPAND_COUNTER(                               \
      ...
      ::auxilia::details::_deferer_helper_struct_{} *[&]()
