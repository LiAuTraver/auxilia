...
public:
  auto begin(this auto &&self) { return self.root_.children_.begin(); }
  auto end(this auto &&self) { return self.root_.children_.end(); }
  auto cbegin(this auto &&self) { return self.root_.children_.cbegin(); }
  auto cend(this auto &&self) { return self.root_.children_.cend(); }
...
public:
  ...
  /// @pre the @e node should be in this Trie.
