...
- [AutomataBase](include/Automaton.hpp): mixin class for `NFA` and `DFA`.
...
> Note: the main file [cp](cp.cpp) is unused. please refer to the [tests](tests) folder for samples.
